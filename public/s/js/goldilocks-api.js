// From: https://gist.github.com/callahad/6807882
...
(function () {
  ...
  console.log('Got old navigator.id.watch()');
  ...
  try {
      ...
      if ('onlogout' in args) {
        throw "Unknown parameter passed to navigator.id.watch() : onlogout";
      }
      if ('onready' in args) {
        throw "Unknown parameter passed to navigator.id.watch() : onready";
      }
      if ('loggedInUser' in args) {
        throw "Unknown parameter passed to navigator.id.watch() : loggedInUser";
      }
